...
export class CreateEditModalComponent implements OnInit {
  ...
  saveProject() {
    ...
    const project: any = {
      ...
      startDate: formatDate(this.newProjectForm.get('startDate').value, 'yyyy-MM-dd HH:mm:ss', 'en-us'),
      endDate: formatDate(this.newProjectForm.get('endDate').value, 'yyyy-MM-dd HH:mm:ss', 'en-us'),
